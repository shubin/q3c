...
#if defined( QC )
	bs->inventory[INVENTORY_TRIBOLT] = (bs->cur_ps.stats[STAT_WEAPONS] & (1 << WP_TRIBOLT)) != 0;
#endif
#ifdef MISSIONPACK
...
#if defined( QC )
	bs->inventory[INVENTORY_BOLTS] = bs->cur_ps.ammo[WP_TRIBOLT];
#endif
...
#if defined( UNLAGGED ) //unlagged - misc
