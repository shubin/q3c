...
#if defined( QC )
	cgs.media.hitSound[0] = trap_S_RegisterSound( "sound/feedback/hit0.wav", qfalse );
	cgs.media.hitSound[1] = trap_S_RegisterSound( "sound/feedback/hit1.wav", qfalse );
	cgs.media.hitSound[2] = trap_S_RegisterSound( "sound/feedback/hit2.wav", qfalse );
#else
...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.piercingSightTwilightShader = trap_R_RegisterShader( "effects/piersingSightTwilight" );
	...
	cgs.media.twilightShader = trap_R_RegisterShader( "effects/twilight" );
	cgs.media.twilightWeaponShader = trap_R_RegisterShader( "effects/twilightWeapon" );
